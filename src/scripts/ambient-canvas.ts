class GameOfLife {
  ...
  private readonly fadeIn = 0.06;
  private readonly fadeOut = 0.02;
  private readonly trailFade = 0.08; // ~0.4s at 30fps
  ...
  private buildPalette() {
    ...
    const ambR = isDark ? 50 : 30, ambG = isDark ? 100 : 80, ambB = isDark ? 180 : 160;
    // Hot: vivid accent blue
    const hotR = isDark ? 77 : 0, hotG = isDark ? 163 : 122, hotB = 255;
  ...
  render() {
    ...
    const baseOpacity = isDark ? 0.09 : 0.06;
    const nearOpacity = isDark ? 0.22 : 0.18;
    const trailMaxOpacity = isDark ? 0.35 : 0.25;
